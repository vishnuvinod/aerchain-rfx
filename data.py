...
RFX = {
    ...
    "line_items": [
        # Category 1: Servers & Storage (6 items)
        {"id": 1,  "code": "SRV-001", "description": "Rack Server 2U",                  "qty": 10,  "unit": "unit", "specs": "Dual Intel Xeon Gold 6330, 128GB DDR5 ECC RAM, 4×1.92TB NVMe SSD, Redundant PSU, IPMI", "category": "Servers & Storage"},
        {"id": 2,  "code": "SRV-002", "description": "Rack Server 1U",                  "qty": 5,   "unit": "unit", "specs": "Single Intel Xeon Silver 4310, 64GB DDR4 ECC, 2×960GB SSD, Redundant PSU",           "category": "Servers & Storage"},
        {"id": 3,  "code": "SRV-003", "description": "Blade Server Chassis",             "qty": 2,   "unit": "unit", "specs": "Full-height blade chassis, 10-blade capacity, dual 10GbE pass-through switches",       "category": "Servers & Storage"},
        {"id": 4,  "code": "SRV-004", "description": "Blade Server Module",              "qty": 8,   "unit": "unit", "specs": "Half-height blade, Intel Xeon Gold, 64GB RAM, 2×800GB SSD RAID-1",                    "category": "Servers & Storage"},
        {"id": 25, "code": "NAS-001", "description": "NAS Storage (4-Bay)",              "qty": 3,   "unit": "unit", "specs": "4-bay NAS, 2×10GbE, hardware RAID 0/1/5/6/10, hot-swap trays, expandable",            "category": "Servers & Storage"},
        ...
        {"id": 9,  "code": "TNC-001", "description": "Thin Client",                      "qty": 30,  "unit": "unit", "specs": "AMD Ryzen R1505G, 8GB RAM, 64GB eMMC, Windows IoT Enterprise",                         "category": "Client Compute & Laptops"},
        {"id": 29, "code": "MON-001", "description": "Monitor 27\" 4K UHD",             "qty": 60,  "unit": "unit", "specs": "27\" UHD IPS 4K, USB-C 65W PD, height/tilt/pivot adjustable, VESA 100×100",            "category": "Client Compute & Laptops"},

        # Category 3: Enterprise Networking (8 items)
        {"id": 10, "code": "NSW-001", "description": "Network Switch 24P L2 (PoE+)",     "qty": 10,  "unit": "unit", "specs": "24×1GbE PoE+, 4×10GbE SFP+ uplinks, managed, 370W PoE budget",                        "category": "Enterprise Networking"},
        {"id": 11, "code": "NSW-002", "description": "Network Switch 48P L2 (PoE+)",     "qty": 5,   "unit": "unit", "specs": "48×1GbE PoE+, 4×10GbE SFP+ uplinks, managed, 740W PoE budget",                        "category": "Enterprise Networking"},
        {"id": 12, "code": "NSW-003", "description": "Network Switch 24P L3",            "qty": 3,   "unit": "unit", "specs": "24×1GbE + 4×10GbE SFP+, Layer-3 routing, stacking capable",                           "category": "Enterprise Networking"},
        {"id": 13, "code": "RTR-001", "description": "Core Router",                      "qty": 2,   "unit": "unit", "specs": "Enterprise router, 2×10GbE WAN, 6×1GbE LAN, SD-WAN capable, hardware failover",        "category": "Enterprise Networking"},
        {"id": 14, "code": "FWL-001", "description": "Enterprise Firewall (NGFW)",       "qty": 2,   "unit": "unit", "specs": "Next-gen firewall, 10Gbps throughput, IPS/IDS, SSL inspection, centralised mgmt",      "category": "Enterprise Networking"},
        {"id": 15, "code": "WAP-001", "description": "Wireless Access Point (Wi-Fi 6)",  "qty": 40,  "unit": "unit", "specs": "Wi-Fi 6 (802.11ax), Dual-band 2.4+5GHz, PoE+, indoor, 160MHz channel support",         "category": "Enterprise Networking"},
        {"id": 16, "code": "WLC-001", "description": "Wireless LAN Controller",          "qty": 2,   "unit": "unit", "specs": "Manages up to 100 APs, centralised SSID management, RF optimisation",                  "category": "Enterprise Networking"},
        {"id": 22, "code": "SFP-001", "description": "SFP+ Module 10GbE SR",             "qty": 20,  "unit": "unit", "specs": "10GBASE-SR, 850nm VCSEL, max 300m OM3, LC duplex, DDM support",                        "category": "Enterprise Networking"},

        # Category 4: Power & Rack Infrastructure (6 items)
        {"id": 17, "code": "UPS-001", "description": "UPS 1 kVA",                        "qty": 20,  "unit": "unit", "specs": "1kVA / 900W, Line-interactive, 10min backup at full load, USB monitoring",              "category": "Power & Infrastructure"},
        {"id": 18, "code": "UPS-002", "description": "UPS 3 kVA",                        "qty": 5,   "unit": "unit", "specs": "3kVA / 2.7kW, Online double-conversion, 20min at 50% load, SNMP card",                 "category": "Power & Infrastructure"},
        {"id": 19, "code": "UPS-003", "description": "UPS 10 kVA",                       "qty": 2,   "unit": "unit", "specs": "10kVA / 9kW, Online double-conversion, scalable battery runtime, parallel capability",  "category": "Power & Infrastructure"},
        {"id": 20, "code": "PDU-001", "description": "Rack PDU (Metered)",               "qty": 10,  "unit": "unit", "specs": "19\" rack mount, 16A, 8×C13 + 2×C19 outlets, per-outlet metering",                    "category": "Power & Infrastructure"},
        {"id": 21, "code": "KVM-001", "description": "IP KVM Switch (8-Port)",           "qty": 5,   "unit": "unit", "specs": "8-port over-IP KVM, remote BIOS access, 1080p, USB+HDMI, web UI",                      "category": "Power & Infrastructure"},
        {"id": 30, "code": "RAK-001", "description": "Server Rack Cabinet 42U",         "qty": 5,   "unit": "unit", "specs": "42U 800×1000mm deep, glass front door, perforated rear, PDU rails, lockable",          "category": "Power & Infrastructure"},

        # Category 5: Passive Cabling & Components (4 items)
        {"id": 23, "code": "CAB-001", "description": "CAT6 Cable (305m box)",            "qty": 15,  "unit": "box",  "specs": "CAT6 UTP solid copper, 305m/box, 23AWG, PVC jacket, TIA-568 compliant",                 "category": "Passive Cabling & Components"},
        {"id": 24, "code": "PAT-001", "description": "Fiber Patch Panel 24-Port",        "qty": 8,   "unit": "unit", "specs": "24-port LC duplex, 1U rackmount, OS2 singlemode, pre-loaded, hinged",                  "category": "Passive Cabling & Components"},
        {"id": 27, "code": "RAM-001", "description": "RAM Module 32GB DDR5 ECC",        "qty": 100, "unit": "unit", "specs": "32GB DDR5-4800 ECC RDIMM, server-grade, registered, heat spreader",                    "category": "Passive Cabling & Components"},
        {"id": 28, "code": "GPU-001", "description": "Data Center GPU",                  "qty": 5,   "unit": "unit", "specs": "NVIDIA A100 40GB PCIe or equivalent, HPC/AI workloads, NVLink support",                "category": "Passive Cabling & Components"},
    ],
    "questionnaire": [
